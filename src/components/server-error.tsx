  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col items-center justify-center">
        <p className="text-5xl dark:text-white md:text-6xl lg:text-7xl font-bold tracking-wider text-gray-600 mt-8">
          500
        </p>
        <p className="text-2xl md:text-3xl lg:text-4xl font-bold dark:text-gray-200 text-gray-600 mt-2">
          Server Error
        </p>
        <p className="md:text-lg dark:text-gray-400 xl:text-xl text-gray-500 mt-4">
