...
export async function POST(request: Request) {
    ...
    try {
        ...
        console.error("Error while requesting money from group members:", error);
        return Response.json(createError("Failed to request money from group members", 500, false));
    }
}